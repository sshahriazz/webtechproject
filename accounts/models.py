...
def pre_save_user_data_receiver(sender, instance, *args, **kwargs):
    if not instance.user_slug:
        instance.user_slug = slugify(instance.username + " " + instance.email)


pre_save.connect(pre_save_user_data_receiver, sender=Account)
